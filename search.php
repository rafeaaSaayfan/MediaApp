    ...
    <div class="main-container">
        <div class="sidebar fixed-top toHideChangePhoto" id="side_nav">
            ...
            <div class="d-flex flex-column justify-content-space-between container">
                ...
                <a class="sideBarBtn p-3 d-flex gap-2 text-decoration-none fw-bold" href="./search.php">
                    <svg enable-background="new 0 0 50 50" id="Layer_1" version="1.1" viewBox="0 0 50 50" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <circle cx="21" cy="20" fill="var(--secondary-color)" r="16" stroke="var(--secondary-color)" stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"/><line fill="red" stroke="var(--secondary-color)" stroke-miterlimit="10" stroke-width="4" x1="32.229" x2="45.5" y1="32.229" y2="45.5"/>
                    </svg>
                    <span>Search</span>
                </a>
            ...
            <div class="container">
                <div class="row pt-4">
                    ...
                    <div class="col-lg-8 col-md-9">
                        <form class="pb-2" role="search">
                            <input class="search px-3 py-2 border-0" type="search" placeholder="Search">
                        </form>
                        <hr>
                    </div>
