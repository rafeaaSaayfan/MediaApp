...
<?php
   if(isset($_POST['submit'])) {
      ...
      $verify_pass = mysqli_query($con, "SELECT password FROM `users_info` WHERE user_id = '$Id' AND password = '$oldPass';");

      if(!empty($oldPass) && !empty($newPass) && mysqli_num_rows($verify_pass) != 0 && strlen($newPass) >= 7 && $newPass === $_POST['Re-newPass']) {
            $sqlUpdate = mysqli_query($con, "UPDATE users_info SET password = '$newPass' WHERE user_id = '$Id';");
...
<head>
  ...
  <link rel="stylesheet" href="./assets/css/editSecurity.css">
   ...
   <div class="content pb-4 pt-1">
        <nav class="navbar fixed-bottom">
            <div class="container d-flex align-items-center">
                ...
                <svg enable-background="new 0 0 32 32" id="Stock_cut" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" class="navbarBtn messaSvg"><desc/><g><polygon fill="none" points="2,3 2,23 6,23    6,29 12,23 30,23 30,3  " 
                    fill="none" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/><circle cx="8" cy="13" r="2" 
                    fill="none" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/><circle cx="16" cy="13" r="2" 
                    fill="none" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/><circle cx="24" cy="13" r="2" 
                ...
                <div class="contentEdit pt-2 mt-3 pb-5 col-lg-8 col-md-8 ms-lg-5">
                    <div class="menuEdit">
                        <ul class="d-flex container">
                            ...
                            <li class="menuEditLi p-2" style="cursor: pointer;">
                                <a href="./editSecurity.php" class="text-decoration-none fw-bold pt-2 pb-2 ps-3 pe-3">Security</a>
                            </li>
                        </ul>                     
                    </div>
                    <div class="container d-flex flex-column gap-4">
                        <h4 style="font-size: 19px;" class="pt-3">Security</h4>
                        <form action="" method="POST" name="form" class="d-flex flex-column gap-5 pt-3">
                                    ...
                                    echo "<div class='container'>";
                                        echo "<div class='row align-items-center'>";
                                            ...
                                            echo "<div class='col-lg-8 col-md-8'>";
                                               echo "<input type='password' placeholder='Current password' name='oldPass' class='form-control'>";
                                              if(isset($_POST['submit'])) {
                                                if(empty($oldPass)) {
                                                    echo "<span style='color: red;'>Enter your old password</span>";
                                                } else if(mysqli_num_rows($verify_pass) == 0) {
                                ...
                                <?php
                                    echo "<div class='container'>";
                                        echo "<div class='row align-items-center'>";
                                            echo "<div class='col-lg-2 col-md-2'></div>";
                                            echo "<div class='col-lg-8 col-md-8'>";
                                               echo "<input type='password' placeholder='New password' name='newPass' class='form-control'>";
                                              if(isset($_POST['submit'])) {
                                                if(empty($_POST['newPass'])) {
                                                    echo "<span style='color: red;'>Enter your new password</span>";
                            ...
                            <div class="RenewPassInput">
                                <?php
                                    echo "<div class='container'>";
                                        echo "<div class='row align-items-center'>";
                                            echo "<div class='col-lg-2 col-md-2'></div>";
                                            echo "<div class='col-lg-8 col-md-8'>";
                                               echo "<input type='password' placeholder='Re-type new password' name='Re-newPass' class='form-control'>";
                                              if(isset($_POST['submit'])) {
                                                if(empty($_POST['Re-newPass'])) {
                                                    echo "<span style='color: red;'>Re-type your new password</span>";
...
<script src="./assets/js/editSecurity.js"></script>
